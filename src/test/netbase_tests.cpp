...
{
    BOOST_CHECK(TestSplitHost("bitcointalk.org/index.php?topic=164569.0", "bitcointalk.org/index.php?topic=164569.0", -1));
    BOOST_CHECK(TestSplitHost("[bitcointalk.org/index.php?topic=164569.0]", "bitcointalk.org/index.php?topic=164569.0", -1));
    BOOST_CHECK(TestSplitHost("bitcointalk.org/index.php?topic=164569.0:80", "bitcointalk.org/index.php?topic=164569.0", 80));
    BOOST_CHECK(TestSplitHost("[bitcointalk.org/index.php?topic=164569.0]:80", "bitcointalk.org/index.php?topic=164569.0", 80));
